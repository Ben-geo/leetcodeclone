...
function useCloseModal(){
	...
	const closeModal=()=>{
		setAuthModal((prev)=>({...prev,isOpen:false,type:"login"})); /* If you dont add the login when you close forgot password 
		and open signup again it goes to the forgot password page*/
	};
